...
This is a Claude Code plugin (`tt`) that automates time entry management between **Intervals Online** and **FreshBooks**. It consists of two skills invoked via slash commands:
...
│   ├── references/             # Mapping files (project, worktype, github, people)
